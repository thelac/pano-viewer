define(function() {
  ...
  var getPano = function(krpano, hash) {
  ...
  return function(krpano, options) {
    ...
    if (options.stView) {
      ...
      request.onreadystatechange = function() {
        ...
        move = function(orientation, floor) {
          ...
          if (hash in cfg) {
            ...
            console.log(x, y, z)
            options.getPano(krpano, hash);
            options.lookAt(krpano, hlookat, vlookat);
          }
        }
      ...
      request.open('GET', config.absModelURL + options.stViewJSON, true);
      request.send(null);
