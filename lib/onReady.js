define(['vendor/hammer.min', 'utils/objectKeys', 'utils/json2', 'utils/addEvent', 'gui/overlay', 'gui/oculusButton'], 
  function(Hammer, objectKeys, JSON, addEvent, overlay, oculusButton) {
